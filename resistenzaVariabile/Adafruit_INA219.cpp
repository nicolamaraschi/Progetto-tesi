...
void Adafruit_INA219::setCalibration_32V_2A() {
  ...
  Serial.println("Setting calibration for 32V, 2A");
  ...
  //  -> optionally modify BADCRES to 12BIT_32S_17MS [default: 12BIT]
  //  -> optionally modify SADCRES to 12BIT_32S_17MS [default: 12BIT_1S_532US]
  uint16_t config = INA219_CONFIG_BVOLTAGERANGE_32V |
                    INA219_CONFIG_GAIN_8_320MV | INA219_CONFIG_BADCRES_12BIT_32S_17MS |
                    INA219_CONFIG_SADCRES_12BIT_32S_17MS |
                    INA219_CONFIG_MODE_SANDBVOLT_CONTINUOUS;
  Serial.println("BADCRES: 12 bit 32 samples 17 ms");
  Serial.println("SADCRES: 12 bit 32 samples 17 ms");
...
void Adafruit_INA219::setCalibration_32V_1A() {
  ...
  Serial.println("Setting calibration for 32V, 1A");
...
void Adafruit_INA219::setCalibration_16V_400mA() {
  ...
  Serial.println("Setting calibration for 16V, 400mA");
